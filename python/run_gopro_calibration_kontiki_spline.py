...
def main():
    ...
    parser.add_argument('--path_calib_dataset', 
                        default='/media/steffen/0F78151A1CEDE4A2/Sparsenet/CameraCalibrationStudy/GoPro6/1080_30/dataset1', 
    ...
    cam_imu_result_json = pjoin(cam_imu_path, "cam_imu_calib_result_kont_"+cam_imu_video_fn+".json")
    cam_imu_calib_json = glob.glob(pjoin(cam_imu_path,"GH**.json"))[0]
