...
def main():
    ...
    parser.add_argument('--path_calib_dataset', 
                        default='/media/steffen/0F78151A1CEDE4A2/Sparsenet/CameraCalibrationStudy/GoPro6/1080_30/', 
    ...
    imu_bias_json =  pjoin(imu_bias_path, "imu_bias"+bias_video_fn+".json")
    ...
    # print("==================================================================")
    # start = time.time()
    # imu_bias_telemetry_json_in = glob.glob(pjoin(imu_bias_path,"*.json"))[0]
    ...
    # #   
    # cam_imu_calib_json = glob.glob(pjoin(cam_imu_path,"*.json"))[0]
    ...
    #                    "--path_to_json=" + cam_imu_calib_json,
    ...
    spline_init = Popen([pjoin(bin_path,"estimate_imu_to_camera_rotation"),
                       "--gopro_telemetry_json=" + cam_imu_calib_json,
