...
// Input/output files.
DEFINE_string(
    telemetry_json, "/media/Data/work_projects/ImageStabelization/GoPro10Calibration/BatchCalib/dataset2_new/cam_imu/GX010020_gen.json",
    "Path to gopro telemetry json extracted with Sparsnet extractor.");
DEFINE_string(input_pose_dataset, "/media/Data/work_projects/ImageStabelization/GoPro10Calibration/BatchCalib/dataset2_new/cam_imu/pose_calib_GX010020.calibdata", "Path to pose dataset.");
DEFINE_string(input_corners, "/media/Data/work_projects/ImageStabelization/GoPro10Calibration/BatchCalib/dataset2_new/cam_imu/cam_imu_corners_GX010020.uson",
              "Corners of the original imu to cam calibration video file.");
DEFINE_string(camera_calibration_json, "/media/Data/work_projects/ImageStabelization/GoPro10Calibration/BatchCalib/dataset2_new/cam/cam_calib_GX010017_ph_2.json", "Camera calibration.");
DEFINE_string(gyro_to_cam_initial_calibration, "/media/Data/work_projects/ImageStabelization/GoPro10Calibration/BatchCalib/dataset2_new/cam_imu/imu_to_cam_calibration_GX010020.json",
...
DEFINE_string(imu_bias_file, "/media/Data/work_projects/ImageStabelization/GoPro10Calibration/BatchCalib/dataset2_new/imu_bias/imu_bias_GX010018.json", "IMU bias json");
DEFINE_bool(global_shutter, false, "If camera has a global shutter.");
DEFINE_string(spline_error_weighting_json, "/media/Data/work_projects/ImageStabelization/GoPro10Calibration/BatchCalib/dataset2_new/cam_imu/spline_info_GX010020.json",
              "Path to spline error weighting data");
DEFINE_string(output_path, "/media/Data/work_projects/ImageStabelization/GoPro10Calibration/BatchCalib/dataset2_new/cam_imu", "");
DEFINE_bool(calibrate_cam_line_delay, false,
            "If camera rolling shutter line delay should be calibrated.");
DEFINE_string(result_output_json, "/media/Data/work_projects/ImageStabelization/GoPro10Calibration/BatchCalib/dataset2_new/cam_imu/cam_imu_calib_result_GX010020.json", "Path to result json file");
...
DEFINE_string(debug_video_path, "/media/Data/work_projects/ImageStabelization/GoPro10Calibration/BatchCalib/dataset2_new/cam_imu/GX010020.MP4",
